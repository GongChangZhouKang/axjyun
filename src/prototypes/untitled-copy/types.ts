...
export type PaymentMethod = '银行转账' | '企业卡' | '现金' | '其他';
...
export type InvoiceType = '增值税专票' | '增值税普票' | '电子普通发票' | '其他';
...
export type GenerateOrderMode = 'single' | 'by-warehouse';
...
export interface TraceRelationActions {
    ...
    openInboundDetail?: (row: FlowRow) => void;
