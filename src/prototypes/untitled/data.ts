...
export const plans: PlanRow[] = [
    {
        ...
        status: '待导入订单',
        auditStatus: '审核通过',
        orderImportStatus: '未导入',
        relatedDemandCodes: ['XQ20260616001', 'XQ20260616002'],
        items: [
    ...
    },
    {
        ...
        status: '订单已导入',
        auditStatus: '审核通过',
        orderImportStatus: '已导入',
        relatedDemandCodes: ['XQ20260616003'],
        items: [
    ...
    },
    {
        ...
        auditStatus: '审核中',
        orderImportStatus: '未导入',
        relatedDemandCodes: ['XQ20260616004'],
        items: [
    ...
    },
    {
        ...
        auditStatus: '待提交',
        orderImportStatus: '未导入',
        relatedDemandCodes: ['XQ20260616005'],
        items: [
...
export const orders: OrderRow[] = [
    {
        ...
        purchaseMethod: '京东慧采',
        allocationMethod: '汇总订单自动分配',
        match: '1项待匹配',
        allocationStatus: '部分分配',
        status: '待商品匹配',
        items: [
    ...
    {
        jdOrder: 'JDHC-20260618-84002',
        plan: 'JH20260616001',
        batch: '第二批',
        supplier: '京东慧采-易安通设备',
        importedAt: '2026-06-18 09:36',
        purchaseMethod: '京东慧采',
        allocationMethod: '分仓库订单',
        match: '已匹配',
...
export const demandPlanAllocations: DemandPlanAllocation[] = [
    { demandCode: 'XQ20260616001', itemName: '夏季短袖执勤服', planCode: 'JH20260616001', includedQty: 160, planQty: 180 },
    { demandCode: 'XQ20260616001', itemName: '反光背心', planCode: 'JH20260616001', includedQty: 120, planQty: 120 },
    { demandCode: 'XQ20260616001', itemName: '强光手电', planCode: 'JH20260616001', includedQty: 18, planQty: 18 },
    { demandCode: 'XQ20260616002', itemName: '强光手电', planCode: 'JH20260616001', includedQty: 22, planQty: 22 },
    { demandCode: 'XQ20260616003', itemName: '手持金属探测器', planCode: 'JH20260616002', includedQty: 6, planQty: 6 },
    { demandCode: 'XQ20260616003', itemName: '防爆毯', planCode: 'JH20260616002', includedQty: 2, planQty: 2 },
    { demandCode: 'XQ20260616004', itemName: '应急救援服', planCode: 'JH20260616003', includedQty: 24, planQty: 24 },
    { demandCode: 'XQ20260616004', itemName: '防火面具', planCode: 'JH20260616003', includedQty: 40, planQty: 40 },
    { demandCode: 'XQ20260616004', itemName: '消防防火毯', planCode: 'JH20260616003', includedQty: 30, planQty: 30 },
    { demandCode: 'XQ20260616005', itemName: '特体执勤服', planCode: 'JH20260616004', includedQty: 18, planQty: 18 },
    { demandCode: 'XQ20260616005', itemName: '特体执勤裤', planCode: 'JH20260616004', includedQty: 18, planQty: 18 },
];
...
export const orderWarehouseAllocations: OrderWarehouseAllocation[] = [
    { orderCode: 'JDHC-20260616-83921', planCode: 'JH20260616001', demandCode: 'XQ20260616001', warehouse: '历下分公司仓', itemName: '夏季短袖执勤服', demandQty: 160, includedQty: 160, orderQty: 180, allocatedQty: 160, manualAdjustQty: 0, inboundCode: 'RK20260616011', inboundStatus: '待入库' },
    { orderCode: 'JDHC-20260616-83921', planCode: 'JH20260616001', demandCode: 'XQ20260616001', warehouse: '历下分公司仓', itemName: '反光背心', demandQty: 120, includedQty: 120, orderQty: 120, allocatedQty: 120, manualAdjustQty: 0, inboundCode: 'RK20260616011', inboundStatus: '待入库' },
    { orderCode: 'JDHC-20260616-83921', planCode: 'JH20260616001', demandCode: 'XQ20260616001', warehouse: '历下分公司仓', itemName: '强光手电', demandQty: 40, includedQty: 18, orderQty: 40, allocatedQty: 18, manualAdjustQty: 0, inboundCode: 'RK20260616011', inboundStatus: '待入库' },
    { orderCode: 'JDHC-20260616-83921', planCode: 'JH20260616001', demandCode: 'XQ20260616002', warehouse: '高新区分公司仓', itemName: '强光手电', demandQty: 80, includedQty: 22, orderQty: 40, allocatedQty: 22, manualAdjustQty: 0, inboundCode: 'RK20260618002', inboundStatus: '待入库' },
    { orderCode: 'JDHC-20260618-84002', planCode: 'JH20260616001', demandCode: 'XQ20260616002', warehouse: '高新区分公司仓', itemName: '强光手电', demandQty: 80, includedQty: 22, orderQty: 20, allocatedQty: 20, manualAdjustQty: 0, inboundCode: 'RK20260618002', inboundStatus: '待入库' },
    { orderCode: 'JDHC-20260616-83944', planCode: 'JH20260616002', demandCode: 'XQ20260616003', warehouse: '会展中心项目点', itemName: '手持金属探测器', demandQty: 6, includedQty: 6, orderQty: 6, allocatedQty: 6, manualAdjustQty: 0, inboundCode: 'RK20260616001', inboundStatus: '待入库' },
    { orderCode: 'JDHC-20260616-83944', planCode: 'JH20260616002', demandCode: 'XQ20260616003', warehouse: '会展中心项目点', itemName: '防爆毯', demandQty: 2, includedQty: 2, orderQty: 2, allocatedQty: 2, manualAdjustQty: 0, inboundCode: 'RK20260616001', inboundStatus: '待入库' },
    { orderCode: 'JDHC-20260615-82710', planCode: 'JH20260616003', demandCode: 'XQ20260616004', warehouse: '历城分公司仓', itemName: '应急救援服', demandQty: 24, includedQty: 24, orderQty: 24, allocatedQty: 18, manualAdjustQty: -6, inboundCode: 'RK20260615003', inboundStatus: '部分入库' },
    { orderCode: 'JDHC-20260615-82710', planCode: 'JH20260616003', demandCode: 'XQ20260616004', warehouse: '历城分公司仓', itemName: '防火面具', demandQty: 40, includedQty: 40, orderQty: 40, allocatedQty: 20, manualAdjustQty: -20, inboundCode: 'RK20260615003', inboundStatus: '部分入库' },
    { orderCode: 'JDHC-20260615-82710', planCode: 'JH20260616003', demandCode: 'XQ20260616004', warehouse: '历城分公司仓', itemName: '消防防火毯', demandQty: 30, includedQty: 30, orderQty: 30, allocatedQty: 20, manualAdjustQty: -10, inboundCode: 'RK20260615003', inboundStatus: '部分入库' },
];

export const inboundTraces: InboundTrace[] = [
    { inboundCode: 'RK20260618002', orderCode: 'JDHC-20260618-84002', planCode: 'JH20260616001', demandCodes: ['XQ20260616002'] },
    { inboundCode: 'RK20260616011', orderCode: 'JDHC-20260616-83921', planCode: 'JH20260616001', demandCodes: ['XQ20260616001', 'XQ20260616002'] },
    { inboundCode: 'RK20260616001', orderCode: 'JDHC-20260616-83944', planCode: 'JH20260616002', demandCodes: ['XQ20260616003'] },
    { inboundCode: 'RK20260615003', orderCode: 'JDHC-20260615-82710', planCode: 'JH20260616003', demandCodes: ['XQ20260616004'] },
    { inboundCode: 'RK20260614009', orderCode: 'JDHC-20260614-81206', planCode: '历史补货计划', demandCodes: ['历史补货'] },
];
